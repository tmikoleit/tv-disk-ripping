...
$result = Match-FilesToEpisodes -FileInfos $fileInfos -FileInfosMs $fileInfosMs -Episodes $episodes
...
$mapping = Build-Mapping -Matches $result.matches -Episodes $episodes -Season $Season -ShowName $Show
